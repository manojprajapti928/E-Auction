  ...
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 md:grid-cols-5 gap-8">
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="#" class="hover:text-white">Teardown</a></li>
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="#" class="hover:text-white">Compare</a></li>
          <li><a href="#" class="hover:text-white">Download</a></li>
          <li><a href="#" class="hover:text-white">Feedback</a></li>
          <li><a href="#" class="hover:text-white">Bug Report</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li><a href="#" class="hover:text-white">Influencers</a></li>
      ...
      <div>
        <h3 class="text-white text-lg font-bold mb-4">Newsletter Subscription</h3>
